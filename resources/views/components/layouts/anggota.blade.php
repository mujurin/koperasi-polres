<!DOCTYPE html>
<html lang="id" class="{{ Cookie::get('appearance', 'light') === 'dark' ? 'dark' : '' }}">
    ...
    <div class="sticky top-0 z-50 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 shadow-sm">
        <div class="flex items-center justify-between px-4 py-3 max-w-lg mx-auto">
            <div class="flex items-center gap-2.5">
                <div
                    class="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 shadow">
                ...
                <div>
                    <p class="text-sm font-bold text-zinc-900 dark:text-white leading-none">Koperasi Polres</p>
                    <p class="text-xs text-zinc-500 dark:text-zinc-400 leading-none mt-0.5">Simpanan Anggota</p>
                </div>
            </div>
